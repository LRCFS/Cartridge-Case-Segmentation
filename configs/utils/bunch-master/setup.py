...
HERE = abspath(dirname('/media/muthumookiah/Data/Retinal Vessel Segmentation/MRK-Experiments/av-classification/configs/utils'))
readme = open(join(HERE, 'segmention_config.json')).read()
